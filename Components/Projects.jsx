...
// Mock project data
const projects = [
  { id: 1, image: '/Screenshot 2024-05-17 224241.png', title: 'Fit-tone', description: "Developed and maintained Fit-Tone, a comprehensive fitness tracker application enabling users to monitor their fitness progress and achieve their health objectives effectively." },
  { id: 2, image: '/Screenshot 2024-05-17 223520.png', title: 'Generative', description: "Generative is a collaborative workspace platform designed to facilitate seamless collaboration, document creation, and content publishing. Powered by Next.js, React, and Node.js Express, it offers robust features for teams to work together effectively and efficiently." },
        ...
        {projects.map(project => (
          ...
          >
            <div className="relative">
              ...
              <div className={`absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-center p-4 transition-opacity duration-500 ease-in-out ${hoveredProject === project.id ? 'opacity-100' : 'opacity-0'}`}>
